...
class PaginasiTabel extends LitTanpaShadowDom {
  static properties = {
  ...
  handleClick(event, index) {
    ...
    let targetElement;
    if (this.tab === 'user') {
      targetElement = this.closest('aplikasi-tabel-pengguna');
    } else {
      targetElement = this.closest('aplikasi-tabel-tamu');
    }
    if (targetElement) {
...
customElements.define('table-pagination', PaginasiTabel);
