...
class HeaderBar extends LitTanpaShadowDom {
  static properties = {
  ...
  render() {
    const createNavItems = html`
      <li><a class="dropdown-item" href="/user/dasbor.html">${msg(`dasbor`)}</a></li>
      <li><a class="dropdown-item" href="/user/pengaturan.html">${msg(`pengaturan`)}</a></li>
      <li><a class="dropdown-item" href="/user/akun.html">${msg(`akun`)}</a></li>
          ...
          >
            ...
            <div class="offcanvas-body d-lg-block">
              <ul class="nav justify-content-end row">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/user/tambah-cerita.html">${msg(`tambah cerita`)}</a>
                </li>
